...
/**
 * The primary key class for the CHARGE_DETAIL database view
 * 
 * @author Arvind Rao
 * 
 */
@Embeddable
public class ChargeDetailPK implements Serializable {
	private static final long serialVersionUID = 1L;
	private Long chargeId;
	private Long organizationId;
	private Long languageId;

	public ChargeDetailPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ChargeDetailPK)) {
			return false;
		}
		ChargeDetailPK castOther = (ChargeDetailPK) other;
