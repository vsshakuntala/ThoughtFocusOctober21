...
public class AdminDocumentFolderHierarchy implements Serializable{
...
//	private DocumentFolder productCategory;
	private AdminDocumentFolder parentDocumentFolder;
...
//	@GeneratedValue(generator="ProductCategoryHierarchySequence")
	...
	@OneToOne
	@JoinColumn(name = "PARENT_DOCUMENT_FOLDER_ID", insertable=true, updatable=false)
	public AdminDocumentFolder getParentDocumentFolder() {
		return parentDocumentFolder;
	}
	public void setParentDocumentFolder(AdminDocumentFolder parentDocumentFolder) {
