...
public class AdminUserPreference implements Serializable {
...
//	private Long userId;
    ...
    public AdminUserPreference() {
    }
    
	public AdminUserPreference(Long userPreferenceId, Integer defaultView,
			Language language, Boolean preload3d, AdminUser user,
