...
public class AdminProductCategoryHierarchy implements Serializable{
	...
	private AdminProductCategory productCategory;
	private AdminProductCategory parentProductCategory;
...
/*	@SequenceGenerator(name = "ProductCategoryHierarchySequence", sequenceName = "SEQ_PRODUCTCATEGORYHRCHY")
	...
	@Column(name="PRODUCT_CATEGORY_ID", insertable=true, updatable=false)
	...
	@Column(name="PARENT_PRODUCT_CATEGORY_ID", insertable=true, updatable=false)
	...
	@Column(name="PRODUCT_CATALOG_ID", insertable=true, updatable=false)
	...
	public AdminProductCategory getProductCategory() {
		return productCategory;
	}
	public void setProductCategory(AdminProductCategory productCategory) {
		this.productCategory = productCategory;
	}
	
	@OneToOne
	@JoinColumn(name = "PARENT_PRODUCT_CATEGORY_ID", insertable=false, updatable=false)
	public AdminProductCategory getParentProductCategory() {
		return parentProductCategory;
	}
	public void setParentProductCategory(AdminProductCategory parentProductCategory) {
