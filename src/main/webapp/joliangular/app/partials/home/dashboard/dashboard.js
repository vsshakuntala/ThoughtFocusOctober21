var dashboardmodule = angular.module('tf.homemodule.dashboardmodule', []);

dashboardmodule.constant('DASHBOARDCONSTANTS', {
    CONFIG: {
...
dashboardmodule.config(
    ['$stateProvider',
        'DASHBOARDCONSTANTS',
        function ($stateProvider, DASHBOARDCONSTANTS) {
            $stateProvider.state(DASHBOARDCONSTANTS.CONFIG.STATE, {
                url: DASHBOARDCONSTANTS.CONFIG.URL,
                templateUrl: DASHBOARDCONSTANTS.CONFIG.TEMPLATEURL,
                controller: DASHBOARDCONSTANTS.CONFIG.CONTROLLER,
                data: {
                    requireLogin: false
                }
            });
...
dashboardmodule.controller('DashboardController',
    ['$scope',
        'dashboardService',
        'DASHBOARDCONSTANTS',
        function ($scope, dashboardService, DASHBOARDCONSTANTS) {
            $(function () {
                /* reportrange */
...
dashboardmodule.factory('dashboardService', ['DASHBOARDCONSTANTS',
